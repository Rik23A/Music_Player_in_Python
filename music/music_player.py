...
window = Tk()
window.title ("Music player by Totan")
...
#right frame
listbox = Listbox(right_frame, selectmode=SINGLE, font=('Arial  9 bold'), width=22, height=10, bg=co3, fg="white")
...
os.chdir(r'E:\Music_mp3') ## music path directory for songs
songs = os.listdir()
